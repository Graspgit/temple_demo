...
<section class="content">
    <div class="container-fluid">
        ...
        <h2><?php echo $lang->account; ?><small><?php echo "Purchase Knock-off"; ?>  / <b><?php echo $lang->list; ?></b></small></h2>
        </div>
        <!-- Basic Examples -->
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        ...
                        <div class="col-md-4" align="right"><a href="<?php echo base_url(); ?>/Knock_off/add?req_typ=2"><button type="button" class="btn bg-deep-purple waves-effect"><?php echo $lang->add; ?></button></a></div></div>
                    </div>
                    <div class="body">
...
<script>
    $("document").ready(function () {
      ...
      // Apply the filter
        ...
        table
            .column( 3 ) // Search in supplier name column
            .search( this.value )
            .draw();
        });
    });
