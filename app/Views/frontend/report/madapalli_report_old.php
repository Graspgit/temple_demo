					...
					<div class="body">	
						<div class="table-responsive col-md-12 det" style="background:#FFF; float:none;">
							...
							<table style="width:100%;" align="center" class="table table-striped dataTable" id="datatables">
								...
								<tbody>
									<?php $i = 1; foreach($prasadam as $row) { ?>
									<tr>
										<td><?php echo $i++; ?></td>
										<td><?php echo $row['name']; ?></td>
										<td><?php echo $row['quantity']; ?></td>
										<td><?php echo $row['session']; ?></td>
										<td><a class="btn btn-warning btn-reprint btn-rad" data-id="<?php echo $row['product_id']; ?>" data-type="1" data-date="<?php echo $from_date; ?>" data-slot="<?php echo $row['session']; ?>" title="Payment Mode"  target="_blank"> Details </a></td>
									</tr>
									<?php } ?>
								</tbody>
							</table>
						...
						<div class="table-responsive col-md-12 det" style="background:#FFF; float:none;">
							...
							<table style="width:100%;" align="center" class="table table-striped dataTable" id="datatables">
								...
								<tbody>
									<?php $i = 1; foreach($annathanam as $row) { ?>
									<tr>
										<td><?php echo $i++; ?></td>
										<td><?php echo $row['name']; ?></td>
										<td><?php echo $row['quantity']; ?></td>
										<td><?php echo $row['session']; ?></td>
										<td><a class="btn btn-warning btn-reprint btn-rad" data-id="<?php echo $row['product_id']; ?>" data-type="2" data-date="<?php echo $from_date; ?>" data-slot="<?php echo $row['session']; ?>" title="Payment Mode"  target="_blank"> Details </a></td>
									</tr>
									<?php } ?>
								</tbody>
							</table>
