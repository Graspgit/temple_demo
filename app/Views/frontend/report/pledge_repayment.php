			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					<!-- Popup Modal -->
						...
						<div class="col-md-12">
							<h3 style="text-align: center" >Pledge Payment</h3>
						</div><br>

						<div class="header1">
                            <form action="<?php echo base_url(); ?>/donation_online/print_pledge_report" method="POST">
                                <div class="container-fluid">
                                    ...
                                    <div class="col-md-2 col-sm-4">
                                        ...
                                        <div class="col-md-2 col-sm-4">
                                            <div class="form-group form-float">
												<div class="form-line">
													<input type="text" maxlength="20" onkeypress="validnumber(event)" id="mobile_no" name="mobile_no" placeholder="Search Mobile" />
                                            ...
                                            <div class="form-group form-float">
												<div class="form-line">
													<select class="form-control" name="status" id="status">
                                                        ...
                                                        <?php
                                                        foreach([1=>"pending",2=>"completed"] as $id=>$status)
                                                        {
                                                        ?>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div style="width:100%" class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" style="text-align: center;" id="repaymentModalLabel"><span id="donation_title"></span> Repayment</h5>
                                        ...
                                        <table>
                                            <tr>
                                                <td><b><div>Total Amount(RM):</div> <div id="totalAmount"></div></b></td>
                                                <td><b><div>Paid Amount(RM):</div> <div id="paidAmount"></div></b></td>
                                                <td><b><div>Balance Amount(RM):</div> <div id="balAmount"></div></b></td>
                                            </tr>
                                        </table>
                                        <div class="modal-body">
                                            <form id="repaymentForm">
                                                ...
                                                <input type="hidden" id="pledge_id" name="pledge_id">
...
<script>
var dclk = false;
function getRepayment(phonecode, mobile, pledge_id, donation_name)
{
    if(dclk) return;
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>/donation_online/payment_check_pledge",
        data: {pledge_id: pledge_id},
        success: function(data) {
            var obj = ("undefined" != typeof data.amt ? data : JSON.parse(data));
            dclk = false;
            
            var totalAmount = parseFloat(obj.amt);
            var paidAmount = parseFloat(obj.paid_amount);
            var balAmount = parseFloat(obj.balance_amount);
            
            $("#donation_title").html(donation_name);
            $("#pledge_id").val(pledge_id);
            $("#phone_code").val(phonecode);  // Fixed field name
            $("#mobile").val(mobile);
            $("#totalAmount").text(totalAmount.toFixed(2));
            $("#paidAmount").text(paidAmount.toFixed(2));
            $("#balAmount").text(balAmount.toFixed(2));
...
(
    ...
    {        
        report = $('#datatables').DataTable({
            ...
            buttons: [],
            "ajax":{
                url: "<?php echo base_url(); ?>/report_online/cash_don_pledge_ref",
                dataType: "json",
                type: "POST",
                data: function ( data ) {
    ...
    // }
    function getIndList(pledge_id)
    {
        window.open("<?php echo base_url() ?>/donation_online/getIndPledgeList/"+pledge_id,"_blank");
        return;
    }
	...
	//console.log("save button clicked");
        ...
        var pay_method = $("#paymentMode").val();
        var total_amount = $("#payAmount").val()
        var pledge_id = $("#pledge_id").val();
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>/donation_online/pledge_balance_post", 
            data: {
                pledge_id: pledge_id,
