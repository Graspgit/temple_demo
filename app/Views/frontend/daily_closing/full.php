				...
				<div class="content-wrapper">
					<div class="row clearfix">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="card">
								<div class="header">
									<form action="<?php echo base_url(); ?>/dailyclosing_online/full" method="post">
										<div class="row" style="margin: 10px 0px">
											...
											<div class="col-md-1" align="right">
												<a href="<?php echo base_url(); ?>/dailyclosing_online/print_a4_full/<?php echo strtotime($dailyclosing_start_date); ?>/<?php echo strtotime($dailyclosing_end_date); ?>"
													target="_blank"><button type="button"
														class="btn btn-info btn-lg ar_btn">Print A4</button></a>
											</div>
											<div class="col-md-1" align="right">
												<a href="<?php echo base_url(); ?>/dailyclosing_online/print_full/<?php echo strtotime($dailyclosing_start_date); ?>/<?php echo strtotime($dailyclosing_end_date); ?>"
													target="_blank"><button type="button"
