...
<body class="sidebar-icon-only">
                                        ...
                                        <div class="col-md-6">
                                          <div class="form-group">
                                            ...
                                            <div class="row">
                                              ...
                                              <div class="col-md-8">
                                                <input class="form-control" type="number" id="mobile" name="mobile" min="0" autocomplete="off" placeholder="">
                                      ...
                                      <div class="row">
                                        <div class="col-md-6">
                                          <div class="form-group">
                                            ...
                                            <input  class="form-control" type="date" id="collection_date" name="collection_date" autocomplete="off" min="<?php echo date('Y-m-d'); ?>" max="<?php echo $booking_calendar_range_year; ?>">
                                          </div>
                                        </div>
  ...
  <script>
    ...
    function loadUserData() {
      console.log("Load user function called");
      var phone_code = $('#phonecode').val();
      var phone_number = $('#mobile').val();
        $.ajax({
            url: "<?php echo base_url(); ?>/prasadam_online/get_devotee_details", 
            method: "POST",
  ...
  <script>
    ...
    function userModalOpen() {
      ...
      if (cartArray.length > 0) {
        ...
        $('.check_time').val(cartArray[0].c_session);
    ...
    $('#ar_add_btn').click(function (event) {
      ...
      var c_session = $('.check_time').val().trim();
      ...
      $('#collection_date').siblings('#error_msg').text('');

      if (mobile == "") {
        $('#mobile').siblings('#error-message').text('Mobile No is required').css('color', 'red');;
      } else {
        $('#mobile').siblings('#error-message').text('').css('color', 'red');;
      }
      // Validate required fields
      if (!name || !phonecode || !mobile ) {
