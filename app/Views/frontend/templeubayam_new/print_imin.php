<body>
    ...
    <?php if (count($abishegam_details)) { ?>
        <tr>
            <td colspan="2">
        ...
        <tr>
            <td colspan="2">
                <table border="1" style="width:100%" align="center">
                    ...
                    <?php
                    foreach ($abishegam_details as $row) { ?>
                        <tr>
                            <td style="font-size: 23px;">
                                <?php echo $row['name']; ?>
                            </td>
