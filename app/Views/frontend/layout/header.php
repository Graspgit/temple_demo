               ...
               <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                  <ul class="navbar-nav">
                     ...
                     if ($_SESSION['log_id_frend'] == 31) {
                        ...
                        <li class="dropdown nav-item <?php if ($uri_one == "Dailyclosing_online"){ echo 'active';} ?>">
							<a class="nav-link" href="#" data-toggle="dropdown">DAILY CLOSING<span class="tw-indicator"><i
                                    class="fa fa-angle-down"></i></span></a>
							<ul class="dropdown-menu tw-dropdown-menu">
								<li><a href="<?php echo base_url(); ?>/Dailyclosing_online">COUNTER CLOSING</a></li>
								<li><a href="<?php echo base_url(); ?>/Dailyclosing_online/full">DAILY CLOSING</a></li>
							</ul>
						</li>
                              ...
                              if (!empty($_SESSION['role'])) {
                                 if ($_SESSION['role'] == 92) {
                                    ...
                                    <li><a href="<?php echo base_url(); ?>/report_online/floating_cash_report">Floating Cash
                                          Report</a></li>
                                          <li><a href="<?php echo base_url(); ?>/report_online/tax_exemption_report">Tax Exemption Report</a></li>
                                    ...
                                    <li><a href="<?php echo base_url(); ?>/report_online/pledge_repayment">Pledge Repayment</a>
                                    </li>
                                    <?php
                                 }
                              }
