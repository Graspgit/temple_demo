								...
								<div class="row">
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<input type="text" required class="form-control" name="payment_receivedfrom" id="payment_receivedfrom" value="<?php if(!empty($entries['paid_to'])){ echo $entries['paid_to']; }?>" autocomplete="off" <?php echo $readonly; ?>>
										</div>
									</div> 
								</div>
