    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>EPF CONTRIBUTION STATEMENT</h2>
                        <ul class="header-dropdown m-r--5">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    ...
                                    <li><a href="<?= base_url('payroll/epf-report?month=' . $month . '&format=csv') ?>"><i class="material-icons">grid_on</i> Export CSV</a></li>
                                </ul>
                            </li>
                            <li>
                            ...
                            <table class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th rowspan="2" class="text-center">No. Ahli KWSP</th>
                                        <th rowspan="2" class="text-center">Nama Ahli</th>
                            ...
                            <div class="col-md-6">
                                <table class="table table-bordered">
                                    <tr>
                                        ...
                                        <td class="text-right"><?= count($epf_data) ?></td>
                                    </tr>
                                    <tr>
                                        <td>Jumlah Gaji</td>
