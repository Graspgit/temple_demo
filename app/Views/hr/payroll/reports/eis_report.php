    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>EIS CONTRIBUTION STATEMENT</h2>
                        <ul class="header-dropdown m-r--5">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    ...
                                    <li><a href="<?= base_url('payroll/eis-report?month=' . $month . '&format=csv') ?>"><i class="material-icons">grid_on</i> Export CSV</a></li>
                                </ul>
                            </li>
                            <li>
                    ...
                    <div class="body">
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <h3>SIP (SISTEM INSURANS PEKERJAAN)</h3>
                            ...
                            <table class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th rowspan="2" class="text-center">No. SIP</th>
                                ...
                                <tbody>
                                    ...
                                    foreach($eis_data as $row): 
                                        $totalWages += $row['gross_salary'];
                                        $totalEmployee += $row['eis_employee'];
                                        $totalEmployer += $row['eis_employer'];
                                        $total = $row['eis_employee'] + $row['eis_employer'];
                                    ?>
                                    <tr>
                                        <td class="text-center"><?= $no++ ?></td>
                                        <td class="text-center"><?= $row['eis_number'] ?? '-' ?></td>
                            ...
                            <div class="col-md-6">
                                <table class="table table-bordered">
                                    <tr>
                                        ...
                                        <td class="text-right"><?= count($eis_data) ?></td>
                                    </tr>
                                    <tr>
                                        <td>Jumlah Gaji</td>
