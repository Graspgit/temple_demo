        ...
        <div class="form-card">
            <div class="form-header">
                <h1>
                    ...
                    <?php echo isset($supplier['id']) ? 'Edit Customer' : 'Add New Customer'; ?>
                </h1>
                <div class="subtitle">
                    <?php echo isset($view) && $view ? 'View customer details' : 'Enter customer information below'; ?>
                </div>
            </div>
            ...
            <div class="form-body">
                ...
                <form action="<?php echo base_url(); ?>/customer/store" method="POST" id="form_validation">
                    ...
                    <div class="form-row">
                        <div class="form-col">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       id="customer_name" 
                                       class="form-control" 
                                       value="<?php echo isset($supplier['customer_name']) ? $supplier['customer_name'] : ""; ?>" 
                                       <?php echo $readonly; ?> 
                                       required 
                        ...
                        <?php if(isset($supplier['customer_code'])): ?>
                        <div class="form-col">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       class="form-control" 
                                       readonly 
                                       value="<?php echo isset($supplier['customer_code']) ? $supplier['customer_code'] : ""; ?>">
                            </div>
                        </div>
                        <?php endif; ?>
                    </div>
                        ...
                        <div class="form-col">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       id="cr_no" 
                                       class="form-control" 
                                       value="<?php echo isset($supplier['cr_no']) ? $supplier['cr_no'] : ""; ?>" 
                                       <?php echo $readonly; ?> 
                    ...
                    <div class="opening-balance-section">
                        <div class="balance-input-group">
                            <div style="flex: 2;">
                                ...
                                <input type="number" 
                                       ...
                                       step="0.01" 
                                       min="0"
                                       value="<?php echo isset($opening_balance_amount) ? $opening_balance_amount : '0'; ?>" 
                                       <?php echo $readonly; ?> 
                                       placeholder="0.00">
                            </div>
                        </div>
                        ...
                        <div class="balance-type-selector">
                            ...
                            <div class="radio-group">
                                <input type="radio" 
                                       ...
                                       id="balance_dr" 
                                       value="dr" 
                                       <?php echo (!isset($opening_balance_dc) || $opening_balance_dc == 'Dr') ? 'checked' : ''; ?>
                                       <?php echo $disable; ?>>
                            ...
                            <div class="radio-group">
                                <input type="radio" 
                                       ...
                                       id="balance_cr" 
                                       value="cr" 
                                       <?php echo (isset($opening_balance_dc) && $opening_balance_dc == 'Cr') ? 'checked' : ''; ?>
                                       <?php echo $disable; ?>>
                                <label for="balance_cr">Credit (We owe them - Advance received)</label>
                            </div>
                        </div>
                        ...
                        <div style="margin-top: 15px; padding: 12px; background: #e6fffa; border-radius: 8px; font-size: 0.9rem; color: #234e52;">
                            ...
                            <strong>Note:</strong> For customers, Debit balance means they owe us money (normal), Credit balance means we owe them money (advance received).
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="btn-container">
                        <button type="submit" class="btn btn-primary">
                            ...
                            <?php echo isset($supplier['id']) ? 'Update Customer' : 'Create Customer'; ?>
                        </button>
                    ...
                    <?php else: ?>
                    <div class="btn-container">
                        <a href="<?php echo base_url(); ?>/customer/edit/<?php echo $supplier['id']; ?>" class="btn btn-primary">
