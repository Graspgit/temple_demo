            ...
            <div class="enhanced-header">
                <div class="enhanced-header-content">
                    <div class="enhanced-header-title">
                        <h2><i class="material-icons">&#xE85C;</i> Sales Orders</h2>
                        <p>Manage and track all your sales orders</p>
                    </div>
                    <div class="enhanced-header-actions">
                        <a href="<?php echo base_url(); ?>/Purchase_order/add?req_typ=1" class="btn-enhanced btn-success">
                            <i class="material-icons">&#xE145;</i> <?php echo $lang->add; ?>
                        </a>
                        <a href="<?php echo base_url(); ?>/purchase_order/purchase_order_purchase" class="btn-enhanced btn-primary">
                            <i class="material-icons">&#xE85B;</i> Purchase Orders
                        </a>
                    </div>
                </div>
                ...
                <div class="filters-section">
                    <div class="filters-grid">
                        ...
                        <div class="filter-group">
                            ...
                            <select id="customerFilter" class="enhanced-form-control">
                                <option value="">All Customers</option>
                                <?php if(!empty($custarr)) {
                                    foreach($custarr as $id => $name) { ?>
                        ...
                        <table class="enhanced-table dataTable" id="datatables">
                            <thead>
                                <tr>
                                    ...
                                    <th>SO Number</th>
                                    <th>Customer <?php echo $lang->name; ?></th>
                            ...
                            <tbody>
                                ...
                                $nm = "";
                                // For sales orders (invoice_type = 1), get customer name
                                if($supplier['invoice_type'] == 1)
                                {
                                ...
                                {
                                    // This should not happen in sales order list, but keeping for safety
        ...
        <div class="enhanced-modal-content">
            ...
            <div class="enhanced-modal-body">
                <div class="enhanced-alert alert-info">
                    <i class="material-icons">&#xE88E;</i>
                    This action will convert the sales order to an invoice. Please provide the invoice details below.
                </div>
...
function applyFilters() {
    ...
    if (customer) {
        // Get customer name from the array
        <?php if(!empty($custarr)) { ?>
        var customerNames = <?php echo json_encode($custarr); ?>;
        if (customerNames[customer]) {
            table.column(2).search(customerNames[customer]);
        }
        <?php } ?>
    }
