                                        ...
                                        <?php 
                                            ...
                                            <?php foreach($prasadam_settings as $row) { ?>
                                                <div class="col-md-4 col-lg-3 col-sm-6 col-xs-12" style="padding-left: 0px;">
                                                    <div class="prod" id="<?php echo $row['id']; ?>" data-id="prod<?php echo $row['id']; ?>" onclick="addtocart(<?php echo $row['id']; ?>)"  style="background:url(<?php echo base_url(); ?>/uploads/prasadam_setting/<?php echo rawurlencode($row['image']); ?>);background-size: cover;background-position: center;">
                                                        <!--<div class="vl"></div>-->
                                                        <div class="detail">
